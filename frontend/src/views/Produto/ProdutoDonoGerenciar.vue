<template>
  <div>
    <v-data-table :headers="headers" :search="search" :items="donosprodutos" sort-by="name" class="elevation-1" v-show="!this.overlay">
      <template v-slot:top>
        <v-toolbar flat color="white">
          ...
          <v-text-field color="purple" v-model="search" append-icon="mdi-magnify" label="Pesquisar" single-line hint="Donos de produto" persistent-hint></v-text-field>
