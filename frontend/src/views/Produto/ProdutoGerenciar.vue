<template>
  <div>
    <v-data-table :headers="headers" :search="search" :items="produtos" sort-by="name" class="elevation-1" v-show="!this.overlay">
      <template v-slot:top>
        <v-toolbar flat color="white">
          ...
          <v-text-field color="purple" v-model="search" append-icon="mdi-magnify" label="Pesquisar" single-line hint="Produto" persistent-hint></v-text-field>
                ...
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" sm="12" md="2">
                      <v-text-field color="purple" v-model="editedItem.amount" type="number" label="Qntd"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="12" md="5">
                      <v-text-field color="purple" v-model="editedItem.price_buy" label="Preço de compra"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="12" md="5">
                      <v-text-field color="purple" v-model="editedItem.price_sell" label="Preço de venda"></v-text-field>
                    </v-col>
                  </v-row>
                  <v-row>
                    <v-col cols="12" sm="12" md="6">
                      <v-select v-model="selected_dono" :items="select_dono" item-text="name" item-value="_id" label="Dono" return-object single-line></v-select>
                    </v-col>
                    <v-col cols="12" sm="12" md="6">
                      <v-select v-model="selected_categoria" :items="select_categoria" item-text="name" item-value="_id" label="Categoria" return-object single-line></v-select>
                    </v-col>
                  </v-row>
                </v-container>
              </v-card-text>
