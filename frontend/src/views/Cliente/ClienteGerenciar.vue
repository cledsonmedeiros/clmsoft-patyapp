<template>
  <div>
    <v-data-table :headers="headers" :items="clientes" :search="search" sort-by="name" class="elevation-1" v-show="!this.overlay">
      <template v-slot:top>
                ...
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" sm="6" md="6">
                      <v-text-field color="purple" v-model="editedItem.contact" v-mask="mascaraTelefone" label="Contato" @keyup.enter="save"></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="6">
                      <v-text-field color="purple" v-model="editedItem.cpf" v-mask="mascaraCPF" class="cpf" label="CPF" @keyup.enter="save"></v-text-field>
                    </v-col>
                  </v-row>
                </v-container>
              </v-card-text>
